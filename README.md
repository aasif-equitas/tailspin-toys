...
The homepage includes category and publisher filters that narrow the prerendered game cards in the browser; multiple categories can be selected together and combined with a publisher.
...
Repository-wide coding standards are maintained in the [Copilot instructions](.github/copilot-instructions.md) and the focused [instruction files](.github/instructions/). In particular:
