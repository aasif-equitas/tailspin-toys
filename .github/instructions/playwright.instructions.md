...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic or non-obvious interactions; never restate the test step.
...
- [ ] Code follows the repository's TypeScript formatting rules and comments explain intent rather than mechanics
